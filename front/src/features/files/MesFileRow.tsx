...
export function MesFileRow({
  ...
  function renderRowActions() {
    if (isExpired) {
      return (
        <p className={styles.expiredMessage}>Ce fichier a expiré, il n'est plus stocké chez nous</p>
      )
    }
    if (isMobileView) {
      return (
          ...
          <button
            ...
            title={
              onLinkRequest
                ...
                : 'Créer un lien de partage (copié dans le presse-papier)'
            }
          >
            <svg
              width="16"
            ...
            >
              <path
                d="M6.5 8.5L9.5 5.5M9.5 5.5C10.5 4.5 12 4.5 13 5.5C14 6.5 14 8 13 9M9.5 5.5C8.5 6.5 8.5 8 9.5 9C10.5 10 12 10 13 9M6.5 7.5L3.5 10.5C2.5 11.5 2.5 13 3.5 14C4.5 15 6 15 7 14L10 11M6.5 7.5C7.5 6.5 9 6.5 10 7.5C11 8.5 11 10 10 11"
                stroke="currentColor"
                strokeWidth="1.6"
                strokeLinecap="round"
                strokeLinejoin="round"
