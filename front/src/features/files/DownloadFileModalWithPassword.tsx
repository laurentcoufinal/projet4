...
export function DownloadFileModalWithPassword({ file, onClose }: DownloadFileModalWithPasswordProps) {
              ...
              <div className={styles.fileInner}>
                <span className={styles.fileIcon24} aria-hidden>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15 8V4H5V20H19V8H15ZM3 2.9918C3 2.44405 3.44749 2 3.9985 2H16L20.9997 7L21 20.9925C21 21.5489 20.5551 22 20.0066 22H3.9934C3.44476 22 3 21.5447 3 21.0082V2.9918ZM11 9.5C11 10.3284 10.3284 11 9.5 11C8.67157 11 8 10.3284 8 9.5C8 8.67157 8.67157 8 9.5 8C10.3284 8 11 8.67157 11 9.5ZM17.5 17L13.5 10L8 17H17.5Z" fill="black" />
                  </svg>
                </span>
                <div className={styles.fileMeta}>
                  <span className={styles.fileNameNoPw} title={file.name}>{file.name}</span>
    ...
    >
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <button
            type="submit"
            className={password.trim() ? `${styles.btnDownload} ${styles.btnDownloadActive}` : styles.btnDownload}
            disabled={loading}
          >
            <span className={styles.btnIcon} aria-hidden>
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_dl_157)">
                  <path d="M5.33378 11.3333L8.00044 14M8.00044 14L10.6671 11.3333M8.00044 14V7.99996M13.9204 12.06C14.5 11.6524 14.9347 11.0707 15.1613 10.3994C15.3879 9.72805 15.3947 9.00197 15.1807 8.32651C14.9667 7.65104 14.543 7.06135 13.9712 6.643C13.3993 6.22464 12.709 5.9994 12.0004 5.99996H11.1604C10.9599 5.21854 10.5848 4.49279 10.0632 3.87734C9.54161 3.2619 8.88721 2.7728 8.14925 2.44686C7.41129 2.12092 6.60901 1.96664 5.80279 1.99563C4.99658 2.02463 4.20745 2.23614 3.49481 2.61424C2.78217 2.99234 2.16459 3.52719 1.68857 4.17851C1.21254 4.82983 0.890478 5.58065 0.746618 6.37445C0.602757 7.16826 0.64085 7.98435 0.85803 8.7613C1.07521 9.53825 1.46582 10.2558 2.00044 10.86" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
                </g>
                <defs>
